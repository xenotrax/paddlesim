...
//if you don't need to execute anything in the LateUpdate and FixedUpdate functions, you should comment both lines of this code below
...
/**
 * class from https://stackoverflow.com/questions/41330771/use-unity-api-from-another-thread-or-call-a-function-in-the-main-thread
 */
public class UnityThread : MonoBehaviour
{
    ...
    void OnDestroy()
    {
        ...
        Debug.LogError("Script was destroyed");
    }
}